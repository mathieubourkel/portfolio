  ...
  return (
    ...
    <article className='flex xl:justify-end self-center xl:w-1/2'>
      ...
      <article className='xl:w-1/2 xl:px-0 flex flex-col self-center'>
        ...
        <p className='mt-5'>{"If you're seeking an autonomous full-stack developer with a robust understanding of infrastructure, demonstrated through past experiences and an AWS Solutions Architect certification, feel free to click below ! :)"}</p>
        </div>
